...
class GlmSimulationData_v0(_object):
    ...
    __swig_setmethods__["_entityRadius"] = _devkit.GlmSimulationData_v0__entityRadius_set
    __swig_getmethods__["_entityRadius"] = _devkit.GlmSimulationData_v0__entityRadius_get
    if _newclass:
        _entityRadius = _swig_property(_devkit.GlmSimulationData_v0__entityRadius_get, _devkit.GlmSimulationData_v0__entityRadius_set)
    __swig_setmethods__["_entityHeight"] = _devkit.GlmSimulationData_v0__entityHeight_set
    __swig_getmethods__["_entityHeight"] = _devkit.GlmSimulationData_v0__entityHeight_get
    if _newclass:
        _entityHeight = _swig_property(_devkit.GlmSimulationData_v0__entityHeight_get, _devkit.GlmSimulationData_v0__entityHeight_set)
...
def initGolaem(useThreadedFramedataDecompression=True):
    return _devkit.initGolaem(useThreadedFramedataDecompression)
